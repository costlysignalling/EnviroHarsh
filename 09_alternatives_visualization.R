...
load("posterior_retain_recognition_10000.RData")
...
load("posterior_retain_homo_10000.RData")
post<-extract.samples(m.big)
...
load("posterior_retain_mistakes_10000.RData")
post<-extract.samples(m.big)
...
png("alternative_posteriors_10000.png",width=(w1/rat[1])*sum(rat),height=28,units="cm",res=600)
...
text(0,const2-0.8,"Target recognitions included",font=2)
...
posts<-postsRmistakes

plot(NULL,ylim=c(const2,0),xlim=c(-1,1),type="n",xaxs="i",yaxs="i",xaxt="n",yaxt="n",bty="n")
text(0,const2-0.8,"All mistake counts",font=2)
...
plot(NULL,ylim=c(const2,0),xlim=c(-1,1),type="n",xaxs="i",yaxs="i",xaxt="n",yaxt="n",bty="n")
text(0,const2-0.8,"All sexual orientations",font=2)
